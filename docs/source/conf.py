...
assert any(entry["image"] == "ghcr.io/uliegecsm/reprospect/cuda-gnu-15-nvidia-py3.14:13.3.1-devel-ubuntu26.04" for entry in matrix)
assert any(entry["kokkos"] == "ghcr.io/uliegecsm/reprospect/cuda-gnu-15-nvidia-py3.14-kokkos-5.1.0:13.3.1-devel-ubuntu26.04-blackwell120" for entry in matrix)
