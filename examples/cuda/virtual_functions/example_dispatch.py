...
from reprospect.test.sass.instruction import LoadConstantMatcher, LoadGlobalMatcher, LoadMatcher, AddressMatcher, ConstantMatcher, OpcodeModsMatcher
from reprospect.tools.binaries import CuObjDump, Function, NVDisasm, ELF
    ...
    def test_detailed_register_usage(self, detailed_register_usage : dict[DispatchType, typing.Any]) -> None:
        ...
        match self.arch.compute_capability.as_int:
            case 70:
                ...
                expt_dynamic = {RegisterType.GPR : (24, 18), RegisterType.PRED : (1, 1)}
            case 75:
            ...
            case 86:
                ...
                expt_dynamic = {RegisterType.GPR : (24, 18), RegisterType.PRED : (1, 1), RegisterType.UGPR : (6, 2), RegisterType.UPRED : (1, 1)}
            case 89 | 120:
                expt_static  = {RegisterType.GPR : (8, 7),   RegisterType.PRED : (1, 1), RegisterType.UGPR : (6, 2)}
                expt_dynamic = {RegisterType.GPR : (24, 18), RegisterType.PRED : (1, 1), RegisterType.UGPR : (6, 2)}
            case _:
