    ...
    * :cite:`ho-exploiting-2017`
    ...
    def any_operand(cls) -> str:
        return PatternBuilder.group(
            PatternBuilder.any(cls.REGZ_LANE, PatternBuilder.zero_or_more(OPERAND_MODIFIER) + PatternBuilder.REGZ, PatternBuilder.IMMEDIATE),
            group = 'operands',
        )
    ...
    def regz_or_immediate(cls) -> str:
        return PatternBuilder.group(PatternBuilder.any(
            PatternBuilder.zero_or_more(OPERAND_MODIFIER) + PatternBuilder.REGZ,
