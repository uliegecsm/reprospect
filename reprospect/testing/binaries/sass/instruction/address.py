...
class GenericOrGlobalAddressMatch:
    ...
    """:py:attr:`reprospect.tools.binaries.sass.decoder.RegisterType.UGPR` from cache policy descriptor."""
...
class AddressMatcher:
    ...
    def build_reg_extend_bits_address(cls, *, arch: NVIDIAArch, reg: str | None = None, offset: str | None = None, captured: bool = False) -> str:
        ...
        See :py:meth:`tests.testing.binaries.sass.instruction.test_address.TestAddressMatcher.test_extend_bits_address_turing75`.
        """
