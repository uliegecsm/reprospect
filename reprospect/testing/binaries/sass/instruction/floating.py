...
def floating_point_add_pattern(*, ftype: typing.Literal['F', 'D']) -> regex.Pattern[str]:
    ...
    * :py:class:`reprospect.testing.binaries.sass.instruction.floating.Fp32AddMatcher`.
    * :py:class:`reprospect.testing.binaries.sass.instruction.floating.Fp64AddMatcher`.
    """
