...
from reprospect.testing.binaries.sass.instruction.operand import (
    MODIFIER_MATH,
    MathModifier,
)
...
class RegisterMatch:
    ...
    ``RZ`` if :py:attr:`rtype` is :py:const:`reprospect.tools.binaries.sass.decoder.RegisterType.GPR`).
    """
    rtype: RegisterType
    index: int = -1
    reuse: bool = False
