"""
Combine matchers from :py:mod:`reprospect.testing.sass.instruction` into sequence matchers.
"""
...
class SequenceMatcher(abc.ABC):
    ...
    def match(self, instructions: typing.Sequence[Instruction | str]) -> list[InstructionMatch] | None:
        ...
        .. note::
            ...
            The `instructions` may be consumed more than once, *e.g.* in :py:class:`reprospect.testing.sass.composite_impl.UnorderedInSequenceMatcher`.
