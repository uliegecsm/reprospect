...
from reprospect.testing.sass.instruction.address import AddressMatcher
...
from reprospect.testing.sass.instruction.memory import (
    MemorySpace,
...
class ReductionMatcher(ArchitectureAwarePatternMatcher):
    ...
    * operation (*e.g.* `ADD`)
    * scope (*e.g.* :py:attr:`reprospect.testing.sass.instruction.atomic.ThreadScope.DEVICE`)
...
class AtomicMatcher(ArchitectureAndVersionAwarePatternMatcher):
    ...
    * https://docs.nvidia.com/cuda/archive/12.6.3/cuda-binary-utilities/index.html#hopper-instruction-set
    ...
    def _build_pattern(self) -> str:
        ...
        match self.arch.compute_capability.as_int:
            case 80 | 86 | 89 | 90 | 100 | 103 | 120 | 121:
