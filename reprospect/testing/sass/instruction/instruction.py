...
from reprospect.testing.sass.instruction.operand import Operand
...
class OpCode:
    ...
    def mod(cls, opcode: str, modifiers: typing.Iterable[str | int | ZeroOrOne] | None = None, *, captured: bool = True) -> str:
        ...
        Modifiers wrapped in a :py:class:`reprospect.testing.sass.instruction.instruction.ZeroOrOne` instance are matched optionally.
        """
...
class PatternMatcher(InstructionMatcher):
    ...
    def build_pattern_operands(cls, operands: typing.Iterable[str | ZeroOrOne] | None = None, *, captured: bool = True) -> str | None:
        ...
        Join multiple operands with a :py:const:`reprospect.testing.sass.instruction.instruction.OPERAND_SEPARATOR` separator.
        Operands wrapped in a :py:class:`reprospect.testing.sass.instruction.instruction.ZeroOrOne` instance are matched optionally.
        """
...
class OpcodeModsWithOperandsMatcher(PatternMatcher):
    ...
    >>> from reprospect.testing.sass.instruction import OpcodeModsWithOperandsMatcher, PatternBuilder
...
class AnyMatcher(PatternMatcher):
    ...
    >>> from reprospect.testing.sass.instruction import AnyMatcher
