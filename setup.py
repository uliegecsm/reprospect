    ...
    * https://mypyc.readthedocs.io/en/latest/getting_started.html#using-setup-py
    ...
    ext_modules = mypycify(
        [
            ...
            'reprospect/testing/binaries/sass/composite_impl.py',
            'reprospect/testing/binaries/sass/composite.py',
            ...
            'reprospect/testing/binaries/sass/matchers/add_int128.py',
            'reprospect/testing/binaries/sass/matchers/add_int32.py',
            'reprospect/testing/binaries/sass/matchers/cas.py',
            'reprospect/testing/binaries/sass/matchers/convert_fp_to_int.py',
            'reprospect/testing/binaries/sass/matchers/convert_fp32_to_fp16.py',
            'reprospect/testing/binaries/sass/matchers/convert_int_to_fp.py',
            'reprospect/testing/binaries/sass/matchers/move32.py',
