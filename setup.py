    ...
    * https://mypyc.readthedocs.io/en/latest/getting_started.html#using-setup-py
    ...
    ext_modules = mypycify(
        [
            ...
            'reprospect/testing/sass/composite_impl.py',
            'reprospect/testing/sass/composite.py',
            'reprospect/testing/sass/controlflow/block.py',
            'reprospect/testing/sass/instruction/address.py',
            'reprospect/testing/sass/instruction/atomic.py',
            'reprospect/testing/sass/instruction/branch.py',
            'reprospect/testing/sass/instruction/constant.py',
            'reprospect/testing/sass/instruction/floating.py',
            'reprospect/testing/sass/instruction/half.py',
            'reprospect/testing/sass/instruction/immediate.py',
            'reprospect/testing/sass/instruction/instruction.py',
            'reprospect/testing/sass/instruction/integer.py',
            'reprospect/testing/sass/instruction/load.py',
            'reprospect/testing/sass/instruction/memory.py',
            'reprospect/testing/sass/instruction/operand.py',
            'reprospect/testing/sass/instruction/pattern.py',
            'reprospect/testing/sass/instruction/register.py',
            'reprospect/testing/sass/instruction/store.py',
            'reprospect/testing/sass/matchers/add_int128.py',
            'reprospect/testing/sass/matchers/add_int32.py',
            'reprospect/testing/sass/matchers/cas.py',
            'reprospect/testing/sass/matchers/convert_fp_to_int.py',
            'reprospect/testing/sass/matchers/convert_fp32_to_fp16.py',
            'reprospect/testing/sass/matchers/convert_int_to_fp.py',
            'reprospect/testing/sass/matchers/move32.py',
