...
class TestAddressMatcher:
    ...
    def test_address(self) -> None:
        ...
        assert AddressMatcher(arch=ARCH, reg='27'                    ).match(ADDRESS_WITH_NEG_OFFSET) is None
        ...
        assert AddressMatcher(arch=ARCH, reg='R42', offset='UR2' ).match(ADDRESS_WITH_NEG_OFFSET) is None
        assert AddressMatcher(arch=ARCH, reg='R42', offset='0x20').match(ADDRESS_WITH_OFFSET) is None
