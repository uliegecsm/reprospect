...
from tests.testing.binaries.sass.test_instruction import get_compilation_output


class TestBasicBlock:
    FILE: typing.Final[pathlib.Path] = pathlib.Path(__file__).parent.parent.parent.parent.parent / 'assets' / 'half.cu'
...
class TestBasicBlockMatcher(TestBasicBlock):
    """
    Tests for :py:class:`reprospect.testing.binaries.sass.controlflow.block.BasicBlockMatcher`.
    """
...
class TestBasicBlockWithParentMatcher(TestBasicBlock):
    """
    Tests for :py:class:`reprospect.testing.binaries.sass.controlflow.block.BasicBlockWithParentMatcher`.
    """
