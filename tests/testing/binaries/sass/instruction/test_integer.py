...
class TestIntAddMatcher:
    """
    Tests for :py:class:`reprospect.testing.binaries.sass.instruction.integer.IntAddMatcher`.
    """
    def test(self) -> None:
...
class TestIntAdd3Matcher:
    """
    Tests for :py:class:`reprospect.testing.binaries.sass.instruction.integer.IntAdd3Matcher`.
    """
...
class TestLEAMatcher:
    """
    Tests for :py:class:`reprospect.testing.binaries.sass.instruction.integer.LEAMatcher`.
    """
    def test(self) -> None:
        matcher = LEAMatcher()
