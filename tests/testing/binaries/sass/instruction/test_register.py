...
class TestRegister:
    """
    Tests for :py:class:`reprospect.testing.binaries.sass.instruction.register.Register`.
    """
    def test_reg_vs_ureg(self) -> None:
        """
        Ensure that :py:attr:`reprospect.testing.binaries.sass.instruction.register.Register.REG` does not
        match what :py:attr:`reprospect.testing.binaries.sass.instruction.register.Register.UREG` matches
        (and vice versa).
        """
...
class TestRegisterMatcher:
    """
    Tests for :py:class:`reprospect.testing.binaries.sass.instruction.register.RegisterMatcher`.
    """
