...
class TestInstructionIs:
    """
    Tests for :py:func:`reprospect.testing.binaries.sass.composite.instruction_is`.
    """
    def test(self) -> None:
    ...
    def test_with_modifier(self) -> None:
        """
        Test :py:meth:`reprospect.testing.binaries.sass.composite.Fluentizer.with_modifier`.
        """
    ...
    def test_with_operand(self) -> None:
        """
        Test :py:meth:`reprospect.testing.binaries.sass.composite.Fluentizer.with_operand`.
        """
    ...
    def test_with_operand_composed(self) -> None:
        ...
        :py:meth:`reprospect.testing.binaries.sass.composite.Fluentizer.with_operand`
        many times.
        """
        matcher = instruction_is(Fp32AddMatcher()).with_operand(
            index=2, operand='R3',
    ...
    def test_with_operands(self) -> None:
        """
        Test :py:meth:`reprospect.testing.binaries.sass.composite.Fluentizer.with_operands`.
        """
...
class TestInstructionCountIs:
    """
    Tests for :py:func:`reprospect.testing.binaries.sass.composite.instruction_count_is`.
    """
    def test(self) -> None:
...
class TestInstructionsAre:
    """
    Tests for :py:func:`reprospect.testing.binaries.sass.composite.instructions_are`.
    """
    def test(self) -> None:
...
class TestUnorderedInstructionsAre:
    """
    Tests for :py:func:`reprospect.testing.binaries.sass.composite.unordered_instructions_are`.
    """
    def test(self) -> None:
...
class TestInstructionsContain:
    """
    Tests for :py:func:`reprospect.testing.binaries.sass.composite.instructions_contain`.
    """
    def test(self) -> None:
...
class TestAnyOf:
    """
    Tests for :py:func:`reprospect.testing.binaries.sass.composite.any_of`.
    """
    def test(self) -> None:
...
class TestInterleavedInstructionsAre:
    """
    Tests for :py:func:`reprospect.testing.binaries.sass.composite.interleaved_instructions_are`.
    """
    def test(self) -> None:
...
class TestUnorderedInterleavedInstructionsAre:
    """
    Tests for :py:func:`reprospect.testing.binaries.sass.composite.unordered_interleaved_instructions_are`.
    """
    def test(self) -> None:
...
class TestFindall:
    """
    Tests for :py:func:`reprospect.testing.binaries.sass.composite.findall`.
    """
    def test(self) -> None:
...
class TestFindunique:
    """
    Tests for :py:func:`reprospect.testing.binaries.sass.composite.findunique`.
    """
    def test(self) -> None:
