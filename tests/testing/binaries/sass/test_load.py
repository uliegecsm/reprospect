...
from tests.testing.binaries.sass.test_instruction import (
...
class TestLoadConstantMatcher:
    """
    Tests for :py:class:`reprospect.testing.binaries.sass.instruction.load.LoadConstantMatcher`.
    """
...
class TestLoadMatcher:
    """
    Tests for :py:class:`reprospect.testing.binaries.sass.instruction.load.LoadMatcher`
    and :py:class:`reprospect.testing.binaries.sass.instruction.load.LoadGlobalMatcher`.
    """
...
"""
    ...
    def test_elementwise_add_restrict(self, request, workdir, parameters: Parameters, cmake_file_api: cmake.FileAPI) -> None:
        """
        Test loads with :py:const:`tests.testing.binaries.sass.test_instruction.CODE_ELEMENTWISE_ADD_RESTRICT`.
        """
        FILE = workdir / f'{request.node.originalname}.{parameters.arch.as_sm}.cu'
    ...
    def test_elementwise_add_restrict_128_wide(self, request, workdir, parameters: Parameters, cmake_file_api: cmake.FileAPI) -> None:
        ...
        :py:const:`tests.testing.binaries.sass.test_instruction.CODE_ELEMENTWISE_ADD_RESTRICT_128_WIDE`.
        """
        FILE = workdir / f'{request.node.originalname}.{parameters.arch.as_sm}.cu'
    ...
    def test_elementwise_add_restrict_256_wide(self, request, workdir, parameters: Parameters, cmake_file_api: cmake.FileAPI) -> None:
        ...
        :py:const:`tests.testing.binaries.sass.test_instruction.CODE_ELEMENTWISE_ADD_RESTRICT_256_WIDE`.
        """
        FILE = workdir / f'{request.node.originalname}.{parameters.arch.as_sm}.cu'
    ...
    def test_sign_extend_s16(self, request, workdir: pathlib.Path, parameters: Parameters, cmake_file_api: cmake.FileAPI, cmake_cuda_compiler: CMakeToolchainCompiler) -> None:
        ...
        Uses :py:meth:`reprospect.testing.features.Memory.sign_extension`.
        """
