...
from reprospect.testing.sass.composite import any_of, interleaved_instructions_are
from reprospect.testing.sass.controlflow.block import (
    BasicBlockMatcher,
    BasicBlockWithParentMatcher,
)
from reprospect.testing.sass.instruction import LoadGlobalMatcher, OpcodeModsMatcher
...
class TestBasicBlockMatcher(TestBasicBlock):
    """
    Tests for :py:class:`reprospect.testing.sass.controlflow.block.BasicBlockMatcher`.
    """
...
class TestBasicBlockWithParentMatcher(TestBasicBlock):
    """
    Tests for :py:class:`reprospect.testing.sass.controlflow.block.BasicBlockWithParentMatcher`.
    """
