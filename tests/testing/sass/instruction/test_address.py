...
from reprospect.testing.sass.instruction import InstructionMatch
from reprospect.testing.sass.instruction.address import (
    AddressMatcher,
...
from reprospect.testing.sass.instruction.instruction import (
...
class TestAddressMatcher:
    """
    Tests for :py:class:`reprospect.testing.sass.instruction.address.AddressMatcher`.
    """
...
"""
    ...
    def test(self, parameters: Parameters) -> None:
        """
        Ensure that :py:meth:`reprospect.testing.sass.instruction.address.AddressMatcher.build_pattern` supports all
