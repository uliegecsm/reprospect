...
class TestFp32AddMatcher:
    """
    Tests for :py:class:`reprospect.testing.sass.instruction.Fp32AddMatcher`.
    """
    def test(self) -> None:
    ...
    def test_elementwise_add_restrict_wide(self, request, workdir, parameters: Parameters, cmake_file_api: cmake.FileAPI):
        """
        Test with :py:const:`tests.testing.sass.test_instruction.CODE_ELEMENTWISE_ADD_RESTRICT_128_WIDE`.
