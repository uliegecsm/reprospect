...
class TestFp16FusedMulAddMatcher:
    """
    Tests for :py:class:`reprospect.testing.sass.instruction.half.Fp16FusedMulAddMatcher`.
    """
...
class TestFp16MulMatcher:
    """
    Tests for :py:class:`reprospect.testing.sass.instruction.half.Fp16MulMatcher`.
    """
    def test_individual(self) -> None:
...
class TestFp16AddMatcher:
    """
    Tests for :py:class:`reprospect.testing.sass.instruction.half.Fp16AddMatcher`.
    """
...
class TestFp16MinMaxMatcher:
    """
    Tests for :py:class:`reprospect.testing.sass.instruction.half.Fp16MinMaxMatcher`.
    """
