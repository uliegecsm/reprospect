...
from reprospect.testing.sass.instruction.branch import BranchMatcher
from reprospect.testing.sass.instruction.instruction import InstructionMatch


class TestBranchMatcher:
    """
    Tests for :py:class:`reprospect.testing.sass.instruction.branch.BranchMatcher`.
    """
