...
from reprospect.testing.sass.composite import findunique
...
class TestReductionMatcher:
    """
    Tests for :py:class:`reprospect.testing.sass.instruction.atomic.ReductionMatcher`.
    """
    CODE_ADD = """\
...
class TestOpcodeModsMatcher:
    """
    Tests for :py:class:`reprospect.testing.sass.instruction.OpcodeModsMatcher`.
    """
...
class TestOpcodeModsWithOperandsMatcher:
    """
    Tests for :py:class:`reprospect.testing.sass.instruction.OpcodeModsWithOperandsMatcher`.
    """
    def test(self):
